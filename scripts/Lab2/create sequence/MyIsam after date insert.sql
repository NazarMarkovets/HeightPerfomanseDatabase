...
-- Schema mu
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `mu` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ;
USE `mu` ;
...
CREATE TABLE IF NOT EXISTS `mu`.`fonts` (
  ...
  `name_font` VARCHAR(100) CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NOT NULL,
  `size` INT NOT NULL,
  `spacing` FLOAT NOT NULL,
  `color_for_headers` VARCHAR(45) CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NOT NULL,
  `color_for_text` VARCHAR(45) CHARACTER SET 'utf8' COLLATE 'utf8_bin' NOT NULL,
  `padding` FLOAT NOT NULL,
  `style` VARCHAR(45) CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NOT NULL,
  `saturation` VARCHAR(45) CHARACTER SET 'utf8' COLLATE 'utf8_bin' NOT NULL,
  `width` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mu`.`format_type` (
  ...
  `nameFormat` VARCHAR(45) CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mu`.`macket_to_print` (
  ...
  `individual_specific` TEXT CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NULL DEFAULT NULL,
  `macketDATA` DATE NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mu`.`order_status` (
  ...
  `name_status` VARCHAR(45) CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NOT NULL DEFAULT 'New',
...
CREATE TABLE IF NOT EXISTS `mu`.`paper` (
  ...
  `name_paper` VARCHAR(45) CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NOT NULL,
  `iso_format` VARCHAR(5) CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NOT NULL,
  `height` INT NOT NULL,
  `width` INT NOT NULL,
  ...
  `covering` VARCHAR(45) CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NOT NULL,
  `description` TEXT CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NOT NULL,
  `paperDATE` DATE NOT NULL,
  PRIMARY KEY (`idPaper`))
ENGINE = MyISAM
AUTO_INCREMENT = 51
DEFAULT CHARACTER SET = utf8
...
CREATE TABLE IF NOT EXISTS `mu`.`paper_brightness` (
  ...
  `describe` VARCHAR(45) CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `mu`.`user` (
  ...
  `snameUser` VARCHAR(45) CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NOT NULL,
  `age` INT NOT NULL,
  `totalSpent` FLOAT NOT NULL DEFAULT '0',
  `emailUser` VARCHAR(100) CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NOT NULL,
  `phoneNumb` VARCHAR(45) CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mu`.`user_role` (
  ...
  `nameStatus` VARCHAR(100) CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NOT NULL DEFAULT 'Customer',
